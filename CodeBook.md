The script run_analysis.R performs first the reading of all datasets dowloaded and then do the 5 activities described in the course project's definition.
